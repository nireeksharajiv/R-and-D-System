...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const handleNewsletterSelect = (newsletter: string) => {
    if (!selectedNewsletters.includes(newsletter)) {
      setSelectedNewsletters([...selectedNewsletters, newsletter]);
    }
  };

  const handleNewsletterClick = (newsletter: string) => {
    // Generate a simple PDF and open it
    const pdfContent = `
      %PDF-1.4
      1 0 obj
      <<
      ...
      /F1 24 Tf
      100 700 Td
      (RNS Institute of Technology) Tj
      0 -50 Td
      /F1 18 Tf
      (Newsletter - ${newsletter}) Tj
      0 -100 Td
      /F1 12 Tf
      (This is a sample newsletter PDF.) Tj
      0 -30 Td
      ...
      <div className="relative z-10 p-8">
        ...
        <footer className="mt-12 bg-[#dfe0db] text-gray-900 py-8">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-gray-700">
                  ...
                  <p>Innovation & Incubation Centre</p>
            ...
            {/* Bottom Footer */}
            <div className="mt-8 pt-6 border-t border-gray-400 text-center text-sm text-gray-700">
              <p>&copy; 2025 RNS Institute of Technology. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
